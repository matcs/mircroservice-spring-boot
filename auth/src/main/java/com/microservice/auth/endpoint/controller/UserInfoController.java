package com.microservice.auth.endpoint.controller;
...
@RestController
@RequestMapping("user")
@Api(value = "Endpoint to user's info")
public class UserInfoController {

    @GetMapping(path = "info", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ApiOperation(value = "ApplicationUser info", response = ApplicationUser.class)
